...
export default function SearchImgRegisResultPage() {
  ...
  return (
    <div className="p-4">
      <h2 className="text-xl font-semibold mb-4">ผลการค้นหาทะเบียนรถ : {plate1} {plate2} {provinceName}</h2>
      ...
      {loading ? (
        ...
        <div>
          <div className="mb-4 flex gap-2">
            <button
              onClick={() => navigate("/search-img-regis")}
